...
import { Ticket, Globe, Zap, Music, MapPin, Menu, X, Calendar, Play, ChevronLeft, ChevronRight, Award, Users, BarChart } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  const navLinks = ['Home', 'Event', 'Result', 'Gallery', 'About Us'];
  ...
  return (
    <div className="relative min-h-screen text-white selection:bg-[#4fb7b3] selection:text-black cursor-auto md:cursor-none overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-40 flex items-center justify-between px-6 md:px-8 py-6 mix-blend-difference">
        <div className="font-heading text-lg md:text-xl font-bold tracking-tighter text-white cursor-default z-50">SYLVESTER'S TECHNOLOGY</div>
      ...
      {/* HOME SECTION */}
      <header id="home" className="relative h-[100svh] min-h-[600px] flex flex-col items-center justify-center overflow-hidden px-4">
        <motion.div 
          style={{ y, opacity }}
        ...
        >
          ...
          >
            <span>ST.SYLVESTER'S COLLEGE</span>
          </motion.div>
          ...
          <div className="relative w-full flex justify-center items-center">
            <div className="flex flex-col items-center">
              <GradientText 
                text="SYLVESTER'S" 
                as="h1" 
                className="text-[10vw] md:text-[9vw] leading-[0.9] font-black tracking-tighter text-center" 
              />
              <GradientText 
                text="TECHNOLOGY" 
                as="h1" 
              ...
              <div key={key} className="flex whitespace-nowrap shrink-0">
                {[...Array(4)].map((_, i) => (
                  <span key={i} className="text-3xl md:text-7xl font-heading font-black px-8 flex items-center gap-4">
                    SYLVESTER'S TECHNOLOGY <span className="text-black text-2xl md:text-4xl">●</span> 
      ...
      {/* EVENT SECTION */}
      <section id="event" className="relative z-10 py-20 md:py-32">
        <div className="max-w-[1600px] mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-5xl md:text-9xl font-heading font-bold opacity-20 text-white">THE EVENT</h2>
          </div>
          
          {/* LINEUP */}
          <div id="lineup" className="mb-20 md:mb-32">
          ...
          {/* EXPERIENCE */}
          <div id="experience" className="mb-20 md:mb-32 bg-black/20 backdrop-blur-sm border-y border-white/10 overflow-hidden py-20 md:py-24">
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 relative">
              <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 md:gap-16 items-center">
                <div className="lg:col-span-5 order-2 lg:order-1">
                  <h3 className="text-4xl md:text-7xl font-heading font-bold mb-6 md:mb-8 leading-tight">
                  ...
                  <p className="text-lg md:text-xl text-gray-200 mb-8 md:mb-12 font-light leading-relaxed drop-shadow-md">
                    Sylvester's Technology isn't just an event; it's a sensory expedition. We fuse cutting-edge audio technology with generative art to create a living, breathing ecosystem of sound.
                  </p>
                  <div className="space-y-6 md:space-y-8">
                    {[
                      ...
                      <div key={i} className="flex items-start gap-6">
                        <div className="p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/5"><feature.icon className="w-6 h-6 text-white" /></div>
                        <div>
                ...
                <div className="lg:col-span-7 relative h-[400px] md:h-[700px] w-full order-1 lg:order-2">
                  ...
                  <div className="relative h-full w-full rounded-3xl overflow-hidden border border-white/10 group shadow-2xl">
                    <img src="https://images.unsplash.com/photo-1492684223066-81342ee5ff30?q=80&w=1000&auto=format&fit=crop" alt="Crowd" className="h-full w-full object-cover transition-transform duration-[1.5s] group-hover:scale-110 will-change-transform" />
                    ...
                    <div className="absolute bottom-6 left-6 md:bottom-10 md:left-10">
                      ...
                      <div className="text-lg md:text-xl font-bold tracking-widest uppercase mt-2 text-white">Interactive Zones</div>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div id="tickets">
            <div className="text-center mb-12 md:mb-20">
              <h3 className="text-5xl md:text-9xl font-heading font-bold opacity-20 text-white">ACCESS</h3>
              <p className="text-[#a8fbd3] font-mono uppercase tracking-widest -mt-3 md:-mt-8 relative z-10 text-sm md:text-base">Secure your frequency</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-7xl mx-auto">
              {[
                ...
                return (
                  <motion.div key={i} whileHover={isDisabled ? {} : { y: -20 }} className={`relative p-8 md:p-10 border border-white/10 backdrop-blur-md flex flex-col min-h-[450px] md:min-h-[550px] transition-colors duration-300 ${ticket.accent} ${isDisabled && !isPurchased ? 'opacity-50 grayscale' : ''} will-change-transform`} data-hover={!isDisabled}>
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-white/20 to-transparent" />
                    <div className="flex-1">
                      <h4 className="text-2xl md:text-3xl font-heading font-bold mb-4 text-white">{ticket.name}</h4>
                      <div className={`text-5xl md:text-6xl font-bold mb-8 md:mb-10 tracking-tighter ${ticket.color === 'white' ? 'text-white' : ticket.color === 'teal' ? 'text-[#4fb7b3]' : 'text-[#637ab9]'}`}>{ticket.price}</div>
                    ...
                    <button onClick={() => handlePurchase(i)} disabled={isDisabled} className={`w-full py-4 text-sm font-bold uppercase tracking-[0.2em] border border-white/20 transition-all duration-300 mt-8 group overflow-hidden relative ${isPurchased ? 'bg-[#a8fbd3] text-black border-[#a8fbd3] cursor-default' : isPurchasing ? 'bg-white/20 text-white cursor-wait' : isDisabled ? 'cursor-not-allowed opacity-50' : 'text-white cursor-pointer hover:bg-white hover:text-black'}`}>
                    ...
                    {isPurchased && (<motion.p initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="text-xs text-center mt-3 text-white/40 font-mono">Demo site: no purchase was made</motion.p>)}
                  </motion.div>
                );
              })}
            </div>
      ...
      {/* RESULT SECTION */}
      <section id="result" className="relative z-10 py-20 md:py-32 bg-black/30 backdrop-blur-lg border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-5xl md:text-9xl font-heading font-bold opacity-20 text-white">RESULTS</h2>
            <p className="text-[#a8fbd3] font-mono uppercase tracking-widest -mt-3 md:-mt-8 relative z-10 text-sm md:text-base">Legacy of Innovation</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: Users, stat: '500+', title: 'Participants', desc: 'From across the globe, uniting the brightest minds in technology.' },
              { icon: Award, stat: '24', title: 'Winning Projects', desc: 'Recognized for their groundbreaking impact and creative solutions.' },
              { icon: BarChart, stat: '98%', title: 'Satisfaction Rate', desc: 'An overwhelmingly positive response from our attendees and partners.' },
            ].map((item, i) => (
              <motion.div 
                key={i}
                className="bg-white/5 border border-white/10 p-8 text-center flex flex-col items-center backdrop-blur-sm"
                whileHover={{ scale: 1.05, backgroundColor: 'rgba(255, 255, 255, 0.1)'}}
                transition={{ type: 'spring', stiffness: 300 }}
              >
                <div className="p-4 rounded-2xl bg-white/10 backdrop-blur-md border border-white/5 mb-6">
                  <item.icon className="w-8 h-8 text-white" />
                </div>
                <div className="text-6xl font-bold text-[#4fb7b3] tracking-tighter mb-2">{item.stat}</div>
      ...
      {/* GALLERY SECTION */}
      <section id="gallery" className="relative z-10 py-20 md:py-32">
        <div className="max-w-[1600px] mx-auto px-4 md:px-6">
          <div className="text-center mb-12 md:mb-20">
            <h2 className="text-5xl md:text-9xl font-heading font-bold opacity-20 text-white">GALLERY</h2>
            <p className="text-[#a8fbd3] font-mono uppercase tracking-widest -mt-3 md:-mt-8 relative z-10 text-sm md:text-base">Visual Archive</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {[
              ...
              <div key={i} className="group relative overflow-hidden aspect-square border border-white/10 bg-black">
                <img src={src} alt={`Gallery image ${i+1}`} className="w-full h-full object-cover transition-all duration-500 ease-in-out group-hover:scale-110 group-hover:brightness-110"/>
      ...
      <footer id="about-us" className="relative z-10 border-t border-white/10 py-12 md:py-16 bg-black/80 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
             <div className="font-heading text-3xl md:text-4xl font-bold tracking-tighter mb-4 text-white">SYLVESTER'S TECHNOLOGY</div>
             <p className="text-gray-300 max-w-lg mb-4">Pioneering the future of technology and innovation. St. Sylvester's College is dedicated to fostering the next generation of creators, thinkers, and leaders through immersive events like this.</p>
          ...
          <div className="flex flex-col items-start md:items-end">
            <h4 className="font-bold uppercase text-sm tracking-widest text-white mb-4">Follow Us</h4>
